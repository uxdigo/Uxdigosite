...
const translations: Record<Language, Translations> = {
  pt: {
    ...
    packagesCount185: '185 pacotes enviados',
    ...
    prototypesDisclaimer: 'Os protótipos apresentados são simulações conceituais criadas para demonstração e não utilizam dados oficiais ou sensíveis.',
    salesFlexTime: 'Até 19h',
    footerCredit: 'Este site foi feito com minhas experiências, Figma, Claude e Codex (GPT).',
    ...
    widgetContext: 'O widget de envios vive dentro da seção de vendas e acompanha o vendedor durante toda a sua operação logística, exibindo informações sobre coletas e envios em tempo real.',
  ...
  en: {
    ...
    packagesCount185: '185 shipped packages',
    ...
    prototypesDisclaimer: 'The prototypes presented are conceptual simulations created for demonstration and do not use official or sensitive data.',
    salesFlexTime: 'Until 7 PM',
    footerCredit: 'This site was made with my experience, Figma, Claude, and Codex (GPT).',
    ...
    widgetContext: 'The shipping widget lives inside the sales section and accompanies the seller throughout their logistics operation, displaying information about pickups and shipments in real time.',
  ...
  es: {
    ...
    packagesCount185: '185 paquetes enviados',
    ...
    prototypesDisclaimer: 'Los prototipos presentados son simulaciones conceptuales creadas para demostración y no utilizan datos oficiales ni sensibles.',
    salesFlexTime: 'Hasta las 19h',
    footerCredit: 'Este sitio fue hecho con mis experiencias, Figma, Claude y Codex (GPT).',
    ...
    widgetContext: 'El widget de envíos vive dentro de la sección de ventas y acompaña al vendedor durante toda su operación logística, mostrando información sobre colectas y envíos en tiempo real.',
