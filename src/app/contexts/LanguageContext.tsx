...
const translations: Record<Language, Translations> = {
  pt: {
    ...
    heroTitle1: 'Crio experiências mais eficientes',
    heroTitle2: 'para o produto e para quem usa ele',
    ...
    heroTitle: 'Crio experiências mais eficientes para o produto e para quem usa ele',
  ...
  en: {
    ...
    heroTitle1: 'I create more efficient experiences',
    heroTitle2: 'for the product and the people who use it',
    ...
    heroTitle: 'I create more efficient experiences for the product and the people who use it',
  ...
  es: {
    ...
    heroTitle1: 'Creo experiencias más eficientes',
    heroTitle2: 'para el producto y para quienes lo usan',
    ...
    heroTitle: 'Creo experiencias más eficientes para el producto y para quienes lo usan',
