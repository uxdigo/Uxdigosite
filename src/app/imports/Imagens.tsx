import svgPaths from "./svg-1uruzawvyf";
  ...
  return (
    <div className="relative shrink-0 size-7" data-name="Icons">
      <svg
        ...
        viewBox="0 0 28 28"
      >
        <g clipPath="url(#clip0_3_743)" id="Icons">
          <g id="Vector"></g>
          <path
  ...
  return (
    <div className="relative shrink-0 size-7" data-name="Icons">
      <svg
        ...
        viewBox="0 0 28 28"
      >
        <g clipPath="url(#clip0_3_721)" id="Icons">
          <g id="Vector"></g>
          <path
...
function Text6() {
  return (
    <div
      className="box-border content-stretch flex flex-col font-['Inter',_sans-serif] font-normal gap-2 items-start justify-start leading-[0] not-italic p-0 relative shrink-0 text-[#000000] text-[16px] text-left w-full"
      data-name="Text"
    >
  ...
  return (
    <div className="relative shrink-0 size-5" data-name="Icons">
      <svg
        ...
        viewBox="0 0 20 20"
      >
        <g clipPath="url(#clip0_3_701)" id="Icons">
          <g id="Group">
            <g id="Vector"></g>
