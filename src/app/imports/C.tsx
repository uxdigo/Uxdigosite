import svgPaths from "./svg-25tmm0uhnz";
  ...
  return (
    <div className="relative shrink-0 size-7" data-name="Icons">
      <svg
        ...
        viewBox="0 0 28 28"
      >
        <g clipPath="url(#clip0_13_3823)" id="Icons">
          <g id="Vector"></g>
          <path
...
function List1() {
  return (
    <div className="relative rounded-3xl shrink-0 w-[312px]" data-name="List">
      <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start overflow-clip px-5 py-4 relative w-[312px]">
        <Text1 />
        <Icons3 />
      </div>
  ...
  return (
    <div className="relative shrink-0 size-7" data-name="Icons">
      <svg
        ...
        viewBox="0 0 28 28"
      >
        <g clipPath="url(#clip0_13_3817)" id="Icons">
          <g id="Vector"></g>
          <path
