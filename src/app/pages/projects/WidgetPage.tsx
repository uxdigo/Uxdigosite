          ...
          <Container>
            <div className="max-w-3xl space-y-4">
              ...
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl">
                {t.widgetDescription1} {t.widgetDescription2} {t.widgetDescription3} {t.widgetDescription4}
              </p>
            </div>
          </Container>
        </section>
          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-4">
                <h2 className="text-xl md:text-2xl font-bold text-[#111111]">{t.demonstrativePrototype}</h2>
